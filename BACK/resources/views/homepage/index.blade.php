...
<body>
    ...
    <!-- ======= Header ======= -->
    <header id="header" class="fixed-top d-none align-items-center">
        <div class="container d-flex justify-content-between align-items-center">
            <div class="logo">
                {{-- <!-- <h1><a href="index.html">SoftLand</a></h1> -->
                <!-- Uncomment below if you prefer to use an image logo --> --}}
                <a href="index.html"><img src="{{url('/SoftLand/')}}/assets/img/logo.png" alt="" class="img-fluid"></a>
            </div>
{{--
                ...
                <div class="col-12 hero-text-image">
                    <div class="row">
                        <div class="col-lg-8 text-center text-lg-start">
                            <h1 data-aos="fade-right">{{$data['Index_text']->value}}</h1>
                            <p class="mb-5" data-aos="fade-right" data-aos-delay="100">{{$data['Index_text']->value1}}
                            </p>
                            <p data-aos="fade-right" data-aos-delay="200" data-aos-offset="-500"><a
                                    href="{{url('/login/')}}" class="btn btn-outline-white">Login</a></p>
                        </div>
                        <div class="col-lg-4 iphone-wrap">
                            <img src="{{url('/SoftLand/')}}/assets/img/phone_1.png" alt="Image" class="phone-1"
                                data-aos="fade-right">
                            <img src="{{url('/SoftLand/')}}/assets/img/phone_2.png" alt="Image" class="phone-2"
    ...
    <main id="main">
        ...
        <!-- ======= Home Section ======= -->
        @if ($data['Index_text_s1']->value=='true')
        <section class="section">
            <div class="container">
                <div class="row justify-content-center text-center mb-5">
                    <div class="col-md-5" data-aos="fade-up">
                        <h2 class="section-heading">Hal yang dimiliki</h2>
                    </div>
                </div>

                <div class="row">
                    <div class="col-md-4" data-aos="fade-up" data-aos-delay="">
                        <?=$data['Index_text_s1']->value1?>
                    </div>
                    <div class="col-md-4" data-aos="fade-up" data-aos-delay="100">
                        <?=$data['Index_text_s1']->value2?>
                    </div>
                    <div class="col-md-4" data-aos="fade-up" data-aos-delay="200">
                        <?=$data['Index_text_s1']->value3?>
                    </div>
                </div>
            </div>
        </section>
        @endif
        @if ($data['Index_text_s3']->value=='true')
        <section class="section">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-4 me-auto">
                        <h2 class="mb-4">{{$data['Index_text_s3']->value1}}</h2>
                        <p class="mb-4">{{$data['Index_text_s3']->value2}}</p>
                        <p><a href="{{$data['Index_text_s3']->value3}}" class="btn btn-primary">unduh sekarang</a></p>
                    </div>
                    <div class="col-md-6" data-aos="fade-left">
                        <img src="{{url('/SoftLand/')}}/assets/img/undraw_svg_2.svg" alt="Image" class="img-fluid">
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="row justify-content-center text-center mb-5" data-aos="fade">
                    <div class="col-md-6 mb-5">
                        <img src="{{$data['Index_text_s2']->value2}}" alt="Image" class="img-fluid">
                    </div>
                </div>
                <?=$data['Index_text_s2']->value1?>
            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6" data-aos="fade-right">
                        <img src="{{url('/SoftLand/')}}/assets/img/undraw_svg_3.svg" alt="Image" class="img-fluid">
        </div>
        </div>
        </div>
        </section> --}}
                            ...
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <div class="review text-center">
                                        ...
                                        <p class="review-user">
                                            <img src="{{url('/SoftLand/')}}/assets/img/person_1.jpg" alt="Image"
        ...
        <div class="swiper-slide">
            <div class="review text-center">
                ...
                <p class="review-user">
                    <img src="{{url('/SoftLand/')}}/assets/img/person_2.jpg" alt="Image"
                        class="img-fluid rounded-circle mb-3">
                    <span class="d-block">
        ...
        <div class="swiper-slide">
            <div class="review text-center">
                ...
                <p class="review-user">
                    <img src="{{url('/SoftLand/')}}/assets/img/person_3.jpg" alt="Image"
                        class="img-fluid rounded-circle mb-3">
                    <span class="d-block">
