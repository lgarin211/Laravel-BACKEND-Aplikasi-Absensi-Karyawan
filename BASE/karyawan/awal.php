                    ...
                    <ul class="navbar-mobile__list list-unstyled">
						...
						<li>
                            <a href="data_absen.php">
                                <i class="fas fa-calendar-alt"></i>Data Absen Masuk</a>
                        </li>
						<li>
                            <a href="data_absen_pulang.php">
                                <i class="fas fa-calendar-alt"></i>Data Absen Pulang</a>
                        </li> 
						<li>
                            <a href="data_keterangan.php">
                                <i class="fas fa-calendar-alt"></i>Data Keterangan</a>
                        </li>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                           <div class="table-responsive table--no-card m-b-30">
                            <form action="modul/karyawan/dt_absen_sv.php" method="post" enctype="multipart/form-data">
						...
						<!-- END FORM ABSEN MASUK -->
						
						<!-- FORM ABSEN MASUK PULANG-->
                        <div class="row">
                           <div class="table-responsive table--no-card m-b-30">
                            <form action="modul/karyawan/dt_absen_pulang_sv.php" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                <table class="table table-borderless table-striped table-earning" >
                                        ...
                                        <tbody>
                                           ...
                                           <tr>
                                            ...
                                            <tr>
                                                <td><button type="submit" name="simpan" class="btn btn-primary">Absen Pulang</button></td>
												<td><input type="reset" name="" value="Batal" class="btn btn-danger"></td>
                     ...
                     <div class="row">
                        ...
                        <div class="header-desktop">
                            <div class="col-md-12">
                                <div class="copyright">
                                    <p>Copyright © 2020 Muhammad Zaki Sahil Mubarok All rights reserved. Template by <a href="https://colorlib.com">Colorlib</a>.</p>
                                </div>
                            </div>
                        </div>
                    </div>
