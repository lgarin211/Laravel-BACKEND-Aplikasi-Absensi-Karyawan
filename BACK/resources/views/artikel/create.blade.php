            ...
            <div class="content mb-0">        
              ...
              <form action="{{url('/make')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="input-style input-style-2 input-required">
                    <span>Lokasi</span>
                    <em>(Wajib)</em>
                    <input class="form-control" required type="text" name="location" placeholder="">
                </div>

                <div class="input-style mt-1 mb-3 has-icon input-required">
                    <i class="input-icon fa fa-calendar"></i>
                    <span class="color-highlight">Tanggal</span>
                    <em>(Wajib)</em>
                    <input class="form-control" type="date" name="date" placeholder="">
                </div> 

                <button class="btn btn-primary" type="submit" name="making">Buat</button>
                <br><br>
