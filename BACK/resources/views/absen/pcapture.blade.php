...
<body class="text-center">
                ...
                <form action="{{url('/absen')}}" method="get" class="form-grup" enctype="multipart/form-data">
                    @csrf
                        <div class="mb-3 bt-2" style="display: none">
                ...
                <button type="button" class="col-md-12 btn btn-lg btn-primary c2" id="snap">Kirim</button>
