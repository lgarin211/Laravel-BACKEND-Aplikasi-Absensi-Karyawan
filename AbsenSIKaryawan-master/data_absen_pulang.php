                        ...
                        <div class="row">
                                ...
                                <div class="table-responsive table--no-card m-b-30">
                                    <table class="table table-borderless table-striped table-earning">
                                        ...
                                        <?php 
                                            include 'koneksi.php';
                                            $sql = "SELECT * FROM tb_absen_pulang";
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $row['waktu']; ?></td>
												 ...
												 <td>
                                                    ...
                                                    if ($row['bukti']!='') {
                                                        echo "<img src=\" karyawan/modul/karyawan/img_absen_pulang/$row[bukti]\" />";
                                                    }else{
                                                        echo "images";
                                                    }
                                                ...
                                                <td> <a href="absen/hapus_absen_pulang.php?id=<?php echo $row['id']; ?>"><button class="btn btn-danger" onclick="return confirm('yakin ingin dihapus?');">Hapus</button></a></td>
